...
SGLassoLogisticRFP64::SGLassoLogisticRFP64(const arma::mat& features,
...
void SGLassoLogisticRFP64::writeModelToXMLStream(std::ofstream& XMLFile)
{
  int i_level = 0;
...
void SGLassoLogisticRFP64::writeSparseMappedWeightsToStream(std::ofstream& MappedWeightsFile, std::ifstream& FeatureMap)
{
  /*
  int i_level = 0;
  //std::string XMLString = "";
...
arma::rowvec& SGLassoLogisticRFP64::Train(const arma::mat& A,
                               const arma::rowvec& responses,
                               const arma::mat& weights,
                               std::map<std::string, std::string> slep_opts,
                               const bool intercept)
...
const arma::colvec SGLassoLogisticRFP64::altra(const arma::colvec& v_in,
                            const int n,
...
const double SGLassoLogisticRFP64::treeNorm(const arma::rowvec& x_in,
                            const int n,
                            const arma::mat& ind_mat,
                            const int nodes) const
{
...
const double SGLassoLogisticRFP64::computeLambda2Max(const arma::rowvec& x_in,
                            const int n,
                            const arma::mat& ind_mat,
                            const int nodes) const
{
...
void SGLassoLogisticRFP64::altra_inplace(double* x, const double* v, int n,
...
double SGLassoLogisticRFP64::treeNorm_flat(const double* x, int n,
                                  const double* ind, int nodes) const
{
    double tree_norm = 0;
    int i, j;
...
double SGLassoLogisticRFP64::computeLambda2Max_flat(const double* x, int n,
                                           const double* ind, int nodes) const
{
    int i, j;
    double twoNorm;
