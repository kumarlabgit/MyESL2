...
void OLSGLassoFP64::writeModelToXMLStream(std::ofstream& XMLFile)
{
  int i_level = 0;
...
void OLSGLassoFP64::writeSparseMappedWeightsToStream(std::ofstream& MappedWeightsFile, std::ifstream& FeatureMap)
{
  std::string line;
...
arma::rowvec& OLSGLassoFP64::Train(const arma::mat& A,
                               const arma::rowvec& responses,
                               const arma::mat& weights,
                               const arma::rowvec& field,
                               std::map<std::string, std::string> slep_opts,
...
const arma::colvec OLSGLassoFP64::altra(const arma::colvec& v_in,
                            const int n,
...
const double OLSGLassoFP64::treeNorm(const arma::rowvec& x_in,
                            const int n,
                            const arma::mat& ind_mat,
                            const int nodes) const
{
...
const double OLSGLassoFP64::computeLambda2Max(const arma::rowvec& x_in,
                            const int n,
                            const arma::mat& ind_mat,
                            const int nodes) const
{
...
void OLSGLassoFP64::altra_inplace(double* x, const double* v, int n,
...
double OLSGLassoFP64::treeNorm_flat(const double* x, int n,
                                  const double* ind, int nodes) const
{
    double tree_norm = 0;
    int i, j;
...
double OLSGLassoFP64::computeLambda2Max_flat(const double* x, int n,
                                           const double* ind, int nodes) const
{
    int i, j;
    double twoNorm;
