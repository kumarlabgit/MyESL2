...
inline void identifySomeZeroEntries(double * u, int * zeroGroupFlag, int *entrySignFlag,
        int *pp, int *gg,
...
inline void xFromY(double *x, double *y,
        double *u, double *Y,
...
inline void dualityGap(double *gap, double *penalty2,
...
inline void overlapping_gd(double *x, double *gap, double *penalty2,
...
inline void gradientDescentStep(double *xnew, double *Ynew,
...
inline void overlapping_agd(double *x, double *gap, double *penalty2,
        double *v, int p, int g, double lambda1, double lambda2,
        double *w, double *G, double *Y, int maxIter, int flag, double tol){
...
inline void overlapping(double *x, double *gap, double *penalty2,
        double *v, int p, int g, double lambda1, double lambda2,
        double *w, double *G, double *Y, int maxIter, int flag, double tol){
    switch(flag){
        case 0:
